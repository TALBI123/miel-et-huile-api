 ...
 *                 success: false
 */
router.get("/users", auth_1.verifyToken, auth_1.verifyAdmin, user_controller_1.getAllUsers);
/**
 * @swagger
 * /users/me:
 *   get:
 ...
 */
router.get("/users/me", auth_1.verifyToken, user_controller_1.getProffile);
/**git commit -m'
 * @openapi
 * /me:
 *   get:
 ...
 */
router.get("/me", auth_1.verifyToken, user_controller_1.getCurrentUser);
/**
 * @swagger
 * /users/me:
 *   delete:
 ...
 *         description: Erreur interne du serveur
 */
router.delete("/users/me", auth_1.verifyToken, user_controller_1.deleteUser);
/**
 * @swagger
 * /users/{id}:
 *   delete:
 ...
 *         description: Erreur interne du serveur
 */
router.delete("/:id", auth_1.verifyToken, auth_1.verifyAdmin, user_controller_1.deleteUserById);
