...
const checkItemsArray_1 = require("../middlewares/checkItemsArray ");
const checkout_schema_1 = require("../schema/checkout.schema");
 ...
 */
router.post("/", auth_1.verifyToken, (0, validate_1.validate)({ schema: checkout_schema_1.CheckoutSchema, skipSave: true }), checkItemsArray_1.checkItemsArray, checkout_controller_1.createCheckoutSession);
